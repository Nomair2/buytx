...
import 'package:marabh/src/auth/presentation/bloc/otp/timer.dart';
...
class VerificationCodePage extends StatelessWidget {
  ...
  Widget _text2(
    ...
    return Text('أدخل رمز التحقق الذي أرسلناه إلى بريدك الإلكتروني',
        textAlign: TextAlign.right,
  ...
  Widget haveCode(BuildContext context) {
    return BlocBuilder<TimerCubit, int>(
      builder: (context, state) {
        ...
        return Text.rich(
            TextSpan(text: 'لم تستلم الرمز؟ ', children: [
              TextSpan(
                  text: ' أعد الإرسال ',
